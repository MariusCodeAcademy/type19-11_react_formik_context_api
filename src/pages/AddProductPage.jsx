export default function AddProductPage() {
  return (
    <div className='container'>
      <h1 className='text-3xl mb-5'>AddProductPage</h1>
      <p>
        ...
        ad tempore eaque obcaecati facilis debitis dicta laboriosam cupiditate reiciendis quibusdam
        deserunt dolores temporibus, officia aliquid error!
      </p>
    </div>
  );
}
